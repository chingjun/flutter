...
class IndexedStack extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    // Each child is wrapped with _VisibilityScope (so Visibility.of reports
    ...
    // these do not introduce any RenderObjects between the child and the
    // enclosing RenderIndexedStack.
    //
    // This allows ParentDataWidgets such as Positioned to correctly apply
...
///
/// Used by [Visibility] and [IndexedStack] to propagate visibility information
/// to descendants.
