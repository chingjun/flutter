...
import 'dart:ui' show Brightness, Canvas, Clip, Color, Offset, Paint, Radius, Rect, SemanticsRole, Size, TextDirection, VoidCallback, clampDouble, lerpDouble;

import 'package:flutter/src/animation/animation.dart' show Animation, AnimationStatusListener;
import 'package:flutter/src/animation/animations.dart' show AnimationWithParentMixin, CurvedAnimation, ReverseAnimation, kAlwaysDismissedAnimation;
import 'package:flutter/src/animation/curves.dart' show Curve, Curves;
import 'package:flutter/src/animation/tween.dart' show ColorTween;
...
import 'package:flutter/src/foundation/diagnostics.dart' show DiagnosticPropertiesBuilder, StringProperty, describeIdentity;
...
import 'package:flutter/src/material/constants.dart' show kDefaultIconDarkColor, kDefaultIconLightColor, kTabLabelPadding, kTabScrollDuration;
...
import 'package:flutter/src/material/tab_indicator.dart' show UnderlineTabIndicator;
...
import 'package:flutter/src/rendering/flex.dart' show CrossAxisAlignment, FlexParentData, MainAxisAlignment, MainAxisSize, RenderFlex;
import 'package:flutter/src/services/mouse_cursor.dart' show MouseCursor;
import 'package:flutter/src/widgets/basic.dart' show Align, Center, Column, CustomPaint, Directionality, Expanded, Flex, KeyedSubtree, LimitedBox, MergeSemantics, Padding, Row, Semantics, SizedBox, Stack;
import 'package:flutter/src/widgets/binding.dart' show WidgetsBinding;
import 'package:flutter/src/widgets/container.dart' show Container;
import 'package:flutter/src/widgets/framework.dart' show BuildContext, GlobalKey, NotificationListener, State, StatefulWidget, StatelessWidget, Widget;
...
import 'package:flutter/src/widgets/page_view.dart' show PageController, PageScrollPhysics, PageView;
...
import 'package:flutter/src/widgets/scroll_notification.dart' show ScrollEndNotification, ScrollNotification, ScrollUpdateNotification;
...
import 'package:flutter/src/widgets/transitions.dart' show AnimatedBuilder, AnimatedWidget;
import 'package:flutter/src/widgets/widget_state.dart' show WidgetState, WidgetStateColor, WidgetStateMouseCursor, WidgetStateProperty;
