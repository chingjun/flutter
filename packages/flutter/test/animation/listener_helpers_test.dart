...
import 'package:flutter/src/animation/listener_helpers.dart' show AnimationLazyListenerMixin, AnimationLocalListenersMixin, AnimationLocalStatusListenersMixin;
...
void main() {
  test(
    ...
    () {
      final uut = _TestAnimationLocalStatusListeners();
  ...
  test(
    ...
    () {
      final uut = _TestAnimationLocalListeners();
      void fakeListener() {}
