...
Usage:
    python3 dev/tools/analyze_imports.py [options] [path_to_all_imports.csv]

Examples:
    python3 dev/tools/analyze_imports.py
    python3 dev/tools/analyze_imports.py --cycles
    python3 dev/tools/analyze_imports.py --format json --output results.json
    python3 dev/tools/analyze_imports.py --direct-symbols --format csv
    python3 dev/tools/analyze_imports.py --transitive --filter widgets/basic.dart
"""
