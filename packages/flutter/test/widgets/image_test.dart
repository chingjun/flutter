...
import 'dart:ui' show BlendMode, Color, Rect, SemanticsFlag, Size, TextDirection;
...
import 'package:flutter/src/painting/debug.dart' show ImageSizeInfo, debugOnPaintImage;
import 'package:flutter/src/painting/edge_insets.dart' show EdgeInsets;
import 'package:flutter/src/painting/image_cache.dart' show ImageCacheStatus;
import 'package:flutter/src/painting/image_provider.dart' show ImageConfiguration, ImageDecoderCallback, ImageProvider, MemoryImage, ResizeImage;
import 'package:flutter/src/painting/image_stream.dart' show ImageChunkEvent, ImageErrorListener, ImageInfo, ImageStream, ImageStreamCompleter, ImageStreamListener, OneFrameImageStreamCompleter;
...
import 'package:flutter/src/widgets/basic.dart' show Builder, Center, Column, Directionality, KeyedSubtree, Padding, RawImage, RepaintBoundary, Row, SizedBox, StatefulBuilder, Transform;
import 'package:flutter/src/widgets/container.dart' show Container, createLocalImageConfiguration;
import 'package:flutter/src/widgets/framework.dart' show BuildContext, Element, GlobalKey, State, StateSetter, Widget;
import 'package:flutter/src/widgets/image.dart' show Image, precacheImage;
...
void main() {
  ...
  testWidgets('errorBuilder prevents FlutterError report even if errorBuilder is later removed', (
    WidgetTester tester,
  ) async {
    ...
    // 6. Verify error reporting behavior.
    expect(
      reportedErrors,
      isEmpty,
      reason:
