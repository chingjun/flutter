...
import 'dart:ui' show SemanticsFlag, TextDirection;

import 'package:flutter/src/rendering/stack.dart' show StackFit;
import 'package:flutter/src/widgets/basic.dart' show Directionality, Semantics, Stack;
    ...
    await tester.pumpWidget(
      Directionality(
        ...
        child: Stack(
          fit: StackFit.expand,
          children: <Widget>[
            Semantics(container: true, label: 'L1'),
            Semantics(
              label: 'L2',
              container: true,
              child: Stack(
                fit: StackFit.expand,
                children: <Widget>[Semantics(checked: true), Semantics(checked: false)],
              ),
            ),
          ],
        ),
      ...
      hasSemantics(
        TestSemantics.root(
          children: <TestSemantics>[
            TestSemantics.rootChild(id: 1, label: 'L1', rect: TestSemantics.fullScreen),
    ...
    await tester.pumpWidget(
      Directionality(
        ...
        child: Stack(
          fit: StackFit.expand,
          children: <Widget>[
            Semantics(label: 'L1', container: true),
            Semantics(
              label: 'L2',
              container: true,
              child: Stack(
                fit: StackFit.expand,
                children: <Widget>[Semantics(checked: true), Semantics()],
              ),
            ),
          ],
        ),
