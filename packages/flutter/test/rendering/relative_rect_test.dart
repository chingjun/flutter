...
void main() {
  test('RelativeRect.==', () {
    const r = RelativeRect.fromLTRB(10.0, 20.0, 30.0, 40.0);
    expect(
      r,
      RelativeRect.fromSize(const Rect.fromLTWH(10.0, 20.0, 0.0, 0.0), const Size(40.0, 60.0)),
    );
  });
  test('RelativeRect.fromDirectional', () {
    final r1 = RelativeRect.fromDirectional(
    ...
    final r2 = RelativeRect.fromDirectional(
  ...
  test('RelativeRect.shift', () {
    const r1 = RelativeRect.fromLTRB(10.0, 20.0, 30.0, 40.0);
  ...
  test('RelativeRect.intersect', () {
    const r1 = RelativeRect.fromLTRB(10.0, 20.0, 30.0, 40.0);
    const r2 = RelativeRect.fromLTRB(0.0, 30.0, 60.0, 0.0);
  ...
  test('RelativeRect.lerp', () {
    ...
    const r2 = RelativeRect.fromLTRB(10.0, 20.0, 30.0, 40.0);
